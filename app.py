...
from z_settings.notifications import notification_router
from z_settings.clearCache import clear_router
...
app.include_router(clear_router, tags=["sensitive"])
...
#     existed = await users_col.find_one({"email": dat  a["email"]})
